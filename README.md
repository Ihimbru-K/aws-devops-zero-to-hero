...
AWS zero to hero repo for devops engineers to learn AWS in 30 Days. This repository contains projects, presentations, interview questions and real time examples. Each day's class will provide real-time knowledge on AWS services, allowing you to apply what you've learned and gain practical skills in working with AWS in a DevOps context.
...
Also, you will be introduced to the basics of AWS, including the core services and their significance in DevOps practices. Finally, you will learn how to set up an AWS account and navigate the AWS Management Console.
